...
- Le modifiche che riguardano solo documentazione (requirements, design, steering, README, commenti nel codice) NON richiedono un bump di versione né la creazione di un tag git. Il version bump si applica solo a modifiche che impattano il codice eseguibile o gli asset della webapp.
